...
public class constant {
    ...
    public static final String API_PROPERTY_FILE_PATH = "E:\\Laxmi\\API\\src\\main\\java\\Configuration\\ConfigFile"; 
    // We need to change the API_PROPERTY_FILE_PATH to property file location 
    public static final String RETIREVER = "retriever";

  
public static final String REPORT_PATH="E:\\Laxmi\\API\\Reporting\\Report";

// we need to change the REPORT_PATH to Reporting folder location
